...
public class Main {
    public static void main(String[] args) {
        ...
        Student eRo = new Student("김이로", 1, 1, 11);
        ...
        attendance.addStudent(bamDol);
        attendance.addStudent(eRo);
        System.out.println();
        ...
        attendance.increaseAttendance(bamDol);
        attendance.increaseAttendance(eRo);
        ...
        attendance.printAllStudents();

        // TODO-7 특정 학생 정보 조회
        // 이밤돌의 출석 횟수를 조회합니다.
        // 김이로의 출석 횟수를 조회합니다.
        attendance.printStudentAttendance(bamDol);
        attendance.printStudentAttendance(eRo);
        System.out.println();

        // TODO-8 출석부에 존재하지 않는 학생 삭제
        // 출석부에서 최시나를 삭제합니다.
        // 출석부에 최시나는 없으므로 존재하지 않는 학생은 삭제가 불가능하다는 메시지가 출력됩니다.
        attendance.removeStudent(siNa);
        System.out.println();

        // TODO-9 출석부에서 학생 삭제
        // 출석부에서 이밤돌을 삭제합니다.
        // 학생이름 + '님이 출석부에서 삭제되었습니다' 라는 메시지가 출력되어야합니다.
        attendance.removeStudent(bamDol);
        System.out.println();

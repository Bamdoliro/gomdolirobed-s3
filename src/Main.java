...
public class Main {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("이밤돌",20309,0);
        Student student2 = new Student("김이로", 10111, 3);
...
//        attendanceList.addStudent(student1);
        ...
        attendanceList.addAttendance(student1,1);
        attendanceList.addAttendance(student2,1);
        // TODO-6 출석부 조회
        ...
        // 이밤돌의 출석 횟수를 조회합니다.
        // 김이로의 출석 횟수를 조회합니다.
        attendanceList.printAttendance(student1);
        attendanceList.printAttendance(student2);
...
//        attendanceList.deleteStudent(student3);
        ...
        attendanceList.deleteStudent(student1);
        // TODO-10 삭제 후 출석부 조회
